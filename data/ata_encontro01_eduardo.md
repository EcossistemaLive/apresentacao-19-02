# ATA — Encontro 01: Onboarding & Diagnóstico Inicial
## Consultoria Estratégica — Eduardo (Top Usados / Broker Digital)
...
| Campo                | Detalhe                                       |
| :------------------- | :-------------------------------------------- |
| **Data/Hora**        | 03/03/2026, ~16h00                            |
| **Local**            | Sede Live Consultoria, Goiânia - GO           |
| **Condutor (Chair)** | Luiz Portal — Sócio-Diretor, Live Consultoria |
| **Duração Estimada** | ~2h                                           |
...
| Tópico                                  | Decisor Final / Autoridade                  |
| :-------------------------------------- | :------------------------------------------ |
| Estratégia de consultoria e metodologia | Luiz Portal (Live Consultoria)              |
| Tecnologia, IA e sistemas               | Cléber Donato (Live Consultoria)            |
| Decisões de negócio e investimento      | Eduardo (Cliente)                           |
| Modelo de negócio e diferenciais        | Eduardo + Luiz Portal (conjunto)            |
| Contratação do Gestor Operacional       | Eduardo (decisão final) + Live (assessoria) |
| Definição de ERP                        | Live (recomendação) + Eduardo (aprovação)   |
...
### 4.1 Apresentação Institucional da Live Consultoria

**Resumo da Discussão:** Luiz apresentou a metodologia de consultoria da Live, enfatizando o sistema operacional de IA (AIOS) criado por Cléber, mentorado de Alan Nicolas (um dos primeiros do mundo). O sistema utiliza mais de uma dezena de agentes de IA coordenados para auxiliar processos operacionais. Destacou-se que o parceiro Ibrahim (sócio de Cléber) atende contratos de R$ 30-70 milhões com governo federal e grandes empresas (Casas Bahia, Heineken), e está começando a usar o AIOS. A Live já atende clientes como TecnoIT, Casa do Picapau, Grupo Roll e Casa Goianita.

**DECISÃO FINAL:** Eduardo demonstrou compreender e aprovar a metodologia. O modelo AIOS será utilizado integralmente na consultoria, com gravação de reuniões, IA processando transcrições e demandando ações da equipe.
...
2. **Anúncios pagos** — Planos por nível de visibilidade (bronze/prata/destaque), modelo vitalício (até vender) — previsto para após 1-2 anos de operação gratuita
3. **Patrocínios** — Parceiros/patrocinadores do portal

**Segmentos do Portal:**
- Veículos usados (principal)
- Veículos novos
- Motos
- Clássicos/colecionadores
- Pesados (caminhões)
- Aluguel de veículos (diferencial — locadoras e particulares anunciam)

**Diferenciais Identificados:**
- Integração com tabela FIPE (comparativo de preço e desvalorização por ano)
- Segmento de clássicos (colecionadores) — concorrentes não possuem
- Segmento de pesados — poucos concorrentes possuem
- Segmento de aluguel — nenhum concorrente direto oferece
- Possibilidade de lojas credenciadas com selo oficial
- Dashboard interno para lojistas (visitas, contatos, tempo de página, origem)
- IA embarcada para busca conversacional (versão beta, similar ao Web Motors)
- Opção de personalização da loja interna para o lojista

**Benchmark de Concorrentes:**
| Portal         | Banco/Dono       | Acessos Mensais   | Preço Anúncio               | Modelo                  |
| :------------- | :--------------- | :---------------- | :-------------------------- | :---------------------- |
...
**DECISÃO FINAL:** O modelo de negócio será formalmente modelado pela consultoria. A estratégia é operar 1-2 anos com anúncios gratuitos para construir base de usuários (meta: 3 milhões de acessos). Monetização via anúncios pagos após atingir massa crítica. Objetivo final: venda do portal ou captação de investimentos.

---

### 4.3 Modelo de Negócio — Broker Digital

**Resumo da Discussão:** Portal de imóveis, 95% finalizado. A parceira principal é a **MyBroker (Guilherme)**, que vai lançar mais de 500 imóveis na plataforma. A Jéssica, gerente do Guilherme, deu carta branca para anunciar. O portal segue o mesmo modelo do Top Usados (anúncios gratuitos inicialmente), mas para imóveis: lançamentos, compra, venda, aluguel e temporada.
...
- LinkedIn (leads mais qualificados para alto padrão, 3-4x mais caro mas hiperqualificado)
- Influenciadores de automóveis no Instagram (parceria, loja oficial no portal)
- Google (tráfego orgânico e pago)

**DECISÃO FINAL:** Será realizado mapeamento formal de ICP para cada segmento. Cada público terá canais vinculados com tom de voz e tipo de conteúdo específicos. A modelagem de negócio será um documento vivo, não um PDF estático.

---

### 4.6 Contratação — Gestor Operacional (Partner Track)

**Resumo da Discussão:** Luiz apresentou a estrutura da vaga de Gestor Operacional com trilha de crescimento para sócio (Partner Track). A pessoa gerenciará tanto o Top Usados quanto o Broker Digital, já que é o mesmo modelo de negócio.

**Trilha de Carreira Definida:**
| Fase        | Período      | Remuneração              | Foco                                   |
| :---------- | :----------- | :----------------------- | :------------------------------------- |
| **Entry**   | 0 — 6 meses  | Fixo (~R$5.000)          | Onboarding, qualificação como gestor   |
| **Growth**  | 6 — 18 meses | Fixo + variável (vendas) | Gestão ativa, crescimento, metas       |
| **Partner** | 18+ meses    | Fixo + equity (~2-3%)    | Elegível a sociedade, cláusulas legais |

**Cláusulas Mencionadas:**
- Drag-along, Tag-along
- Direito de recompra pelo investidor a qualquer momento no período Partner
- Valor pré-estabelecido para saída
- 3 contratos sucessivos (Entry → Growth → Partner → Acordo Societário)
...
- Pretensão: ~R$5.000
- Avaliação: perfil positivo (sabe mexer com sistemas, lidar com gente, bem relacionada, não fechou portas)

**DECISÃO FINAL:** O processo seletivo será conduzido em paralelo. A vaga será publicada e a Live utilizará IA para triagem de currículos. Canais de divulgação: indicações, LinkedIn, Instagram, recrutadoras especializadas. O plano de carreira será detalhado para atrair candidatos de qualidade.
...
- Parceiros no Rio de Janeiro, Campinas/SP, Recife e Salvador (para expansão do Top Usados)
- Gustavo (parceiro em outro negócio, amigo em comum)
- Marcelo (2º sócio investidor, mora em Goiânia)

**DECISÃO FINAL:** Eduardo vai enviar dados dos CNPJs, estrutura contábil e demais informações pendentes à noite/no dia seguinte. Será criado grupo de WhatsApp para comunicação do projeto. O programador principal será incluído no grupo para responder questões técnicas.

---

## 5. PLANO DE AÇÃO

| ID   | Ação / Entregável                                                     | Justificativa                                             | Responsável                 | Prazo        | Dependência / Como                | Status    |
| :--- | :-------------------------------------------------------------------- | :-------------------------------------------------------- | :-------------------------- | :----------- | :-------------------------------- | :-------- |
| 01   | Enviar dados dos CNPJs e estrutura contábil                           | Necessário para formalizar proposta e modelagem           | Eduardo                     | 04/03/2026   | Eduardo vai mandar à noite/amanhã | A iniciar |
| 02   | Criar grupo de WhatsApp do projeto                                    | Canal de comunicação ágil                                 | Cléber                      | 04/03/2026   | —                                 | A iniciar |
| 03   | Incluir programador principal (Prof. Alexandre) no grupo              | Respostas técnicas sobre fluxos                           | Eduardo                     | 04/03/2026   | Após criação do grupo             | A iniciar |
| 04   | Modelagem formal do negócio (Business Model Canvas)                   | Base para planejamento e rodada de investimentos          | Luiz + Cléber               | Encontro 2   | Dados do cliente                  | A iniciar |
| 05   | Mapeamento de ICP por segmento (Top Usados + Broker Digital)          | Definir público e canais corretos por produto             | Luiz Portal                 | Semana 3-4   | Discussão com Eduardo             | A iniciar |
| 06   | Benchmark completo dos 5 concorrentes (veículos)                      | Cruzamento de dados para posicionamento                   | Live + IA                   | Semana 2-3   | Acesso aos portais                | A iniciar |
...
| 14   | Slogan para Top Usados                                                | Diferenciar de portal de empresa única                    | Live + Eduardo              | Encontro 2   | Brainstorming                     | A iniciar |
| 15   | Pesquisa com usuários/vendedores                                      | Validar proposta de valor e diferenciais percebidos       | Live (empresa terceirizada) | Mês 2        | Orçamento aprovado                | A iniciar |
...
3. **Quantidade de CNPJs:** Eduardo confirmou ter "vários CNPJs, todos separados". É necessário mapear qual CNPJ será usado para o contrato e se há implicações fiscais cruzadas.

4. **Período de operação gratuita (1-2 anos):** A estratégia de não cobrar anúncios por 1-2 anos precisa de projeção de burn rate e sustentabilidade financeira.

5. **APIs de locadoras:** Eduardo informou que locadoras derrubam APIs não-autorizadas. O modelo de aluguel depende de cadastro direto pelas locadoras, não integração técnica.
...
## 7. ESTACIONAMENTO (IDEIAS PARA O FUTURO)

- **IA para avaliação de fotos de carros:** Criar máscara/guia para enquadramento de fotos nos anúncios
...
- **NPS do portal:** Implementar sistema de feedback contínuo do usuário
- **Fred (curador de carros):** Amigo que faz curadoria de veículos (cobra R$1.000/serviço) — modelo de serviço a integrar

---

*Ata gerada automaticamente pelo sistema AIOS — Live Consultoria © 2026*
*Protocolo V6.0 | Secretário Executivo IA*
